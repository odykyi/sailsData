...
!(function (a) { if ('object'==typeof exports && "undefined"!==typeof module)module.exports = a(); else if ('function'==typeof define && define.amd)define([], a); else { var b; b = "undefined"!==typeof window ? window:'undefined'!=typeof global ? global:'undefined'!=typeof self ? self:this, b.io = a() } }(() => {
    ...
    SailsSocket.prototype._connect = function () {
      ...
      (function selfInvoking(cb) {
        ...
        self.on('reconnect', (transport, numAttempts) => {
          ...
          let msSinceConnectionLost = ((new Date()).getTime() - self.connectionLostTimestamp);
          let numSecsOffline = (msSinceConnectionLost / 1000);
          consolog(
            `${'\n'+
